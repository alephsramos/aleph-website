...
Como podemos te ajudar? 🤗`,sent:!1}])},400);return()=>clearTimeout(N)},[]),v.jsxs(Sk,{children:[v.jsx(Ek,{onClick:()=>window.open(O,"_blank"),id:"clickwpp","data-aos":"fade-up","data-aos-delay":"200",children:v.jsx(XS,{id:"clickwpp"})}),e&&v.jsxs(bk,{children:[v.jsx(Ck,{onClick:E,children:v.jsx(JS,{})}),v.jsxs(Tk,{children:[l.map(N=>v.jsxs(Jm,{sent:N.sent,children:[!N.sent&&v.jsx(kk,{src:L,alt:"Bot"}),v.jsxs(Ik,{sent:N.sent,children:[!N.sent&&v.jsx(Pk,{children:"aleph"}),v.jsx("div",{children:N.text})]})]},N.id)),p&&v.jsx(Jm,{children:v.jsx(Nk,{})})]}),!x&&v.jsxs(Mk,{children:[v.jsx(Ok,{id:"chat-iniciado",type:"text",placeholder:"Digite sua mensagem",value:s,onChange:N=>o(N.target.value),onKeyDown:T}),v.jsx(Ak,{onClick:P,children:"Enviar"})]})]})]})},jk=ee.footer`
    position: absolute;
    left: 50%;
    bottom: -50px;
    transform: translateX(-50%);
