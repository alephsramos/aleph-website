...
`;function f0(){const[i,n]=fe.useState(!1),o=fe.useRef(null);return fe.useEffect(()=>{$n.init({duration:1500,offset:20,easing:"ease-in-out",once:!0})},[]),fe.useEffect(()=>{const s=()=>{n(!0),o.current&&clearTimeout(o.current),o.current=setTimeout(()=>{n(!1)},200)};return window.addEventListener("scroll",s),()=>{window.removeEventListener("scroll",s),o.current&&clearTimeout(o.current)}},[]),m.jsx(d0,{scrolling:i,children:m.jsx(c0,{"data-aos":"zoom-out-top","data-aos-delay":"100",children:m.jsx("a",{href:"#",children:m.jsx("img",{src:"https://res.cloudinary.com/dabucfkmg/image/upload/v1735248380/white_mkxq1r.png",alt:"logo"})})})})}const p0=ee.button`
    display: flex;
    align-items: center;
    justify-content: center;
    gap: 10px;
...
`,Hn=()=>m.jsx(m.Fragment,{children:m.jsxs(p0,{id:"click-button","data-aos":"fade-up","data-aos-delay":"200",onClick:()=>{window.open("https://w.app/5AaZMJ","_blank")},children:[m.jsx("b",{children:"Solicitar orçamento"}),m.jsx("img",{src:"https://res.cloudinary.com/dabucfkmg/image/upload/v1735248623/iconColorido_bdgxgi.png"})]})}),m0=ee.button`
    display: flex;
    align-items: center;
    justify-content: center;
    gap: 10px;
...
`,h0=()=>m.jsx(m.Fragment,{children:m.jsx(m0,{id:"click-button","data-aos":"fade-up","data-aos-delay":"200",onClick:()=>{window.open("https://w.app/5AaZMJ","_blank")},children:m.jsx("b",{children:"Saber mais"})})});la`
  0% {
    transform: scale(1);
  }
  50% {
...
`,rp=()=>m.jsx(m.Fragment,{children:m.jsxs(Ev,{id:"click-button","data-aos":"fade-up","data-aos-delay":"200",onClick:()=>{window.open("https://w.app/5AaZMJ","_blank")},children:[m.jsx("b",{children:"Solicitar orçamento"}),m.jsx("img",{src:"https://res.cloudinary.com/dabucfkmg/image/upload/v1735248625/iconWhite_muzw7l.png"})]})}),Tv=la`
    0% {
...
`,Vv=({images:i,activeIndex:n})=>{const[o,s]=fe.useState(!1);return fe.useEffect(()=>{s(!1);const u=setTimeout(()=>{s(!0)},50);return()=>clearTimeout(u)},[n]),n===null||n<0||n>=i.length?m.jsx("div",{children:"Nenhuma imagem selecionada."}):m.jsx($v,{isVisible:o,children:m.jsx("img",{src:i[n],alt:`Imagem ${n+1}`})})},Hv=ee.div`
    width: 100%;
    height: 100%;
    position: absolute;
    transform: translateX(-50%);
...
`,Yv=()=>{const[i,n]=fe.useState(0),o=[{title:"Exclusividade",text:"Contato direto com o desenvolvedor para atendimento ágil e personalizado."},{title:"Manutenção gratuita",text:"Suporte completo por 12 meses, sem custos extras."},{title:"Aprenda a mexer no seu site",text:"Treinamento prático para você gerenciar tudo com facilidade."},{title:"Descontos em outros serviços",text:"Acesso a condições especiais em serviços adicionais."}],s=["https://res.cloudinary.com/dabucfkmg/image/upload/v1735406828/1_wpksrg.png","https://res.cloudinary.com/dabucfkmg/image/upload/v1735406829/2_yx40ez.png","https://res.cloudinary.com/dabucfkmg/image/upload/v1735406829/3_dvzidx.png","https://res.cloudinary.com/dabucfkmg/image/upload/v1735406829/4_izdnqm.png"],u=d=>{n(d)};return m.jsx(m.Fragment,{children:m.jsxs(Gv,{children:[m.jsx(Hv,{}),m.jsxs(Wv,{children:[m.jsxs(qv,{children:[m.jsxs("h1",{"data-aos":"fade-up-right","data-aos-delay":"100",children:[m.jsx("b",{children:"Para te motivar"}),", dedicamos alguns benefícios a você"]}),m.jsx("div",{"data-aos":"fade-up","data-aos-delay":"200",children:m.jsx(Ll,{items:o,onTextClick:u})}),m.jsx(Hn,{})]}),m.jsx(Uv,{"data-aos":"fade-up-left","data-aos-delay":"200",children:m.jsx(Vv,{images:s,activeIndex:i})})]})]})})},Xv=ee.div`
    display: flex;
    flex-direction: column;
    align-items: flex-start;
    justify-content: space-between;
...
`,$1=ee.button`
  ...
  font-weight: 400;
  width: 30%;
`,V1=({footerRendered:i})=>{const[n,o]=fe.useState(!1),[s,u]=fe.useState(""),[d,p]=fe.useState([]),[g,f]=fe.useState(!1),[x,v]=fe.useState("Número inválido"),[y,k]=fe.useState(!1),[b,z]=fe.useState(!1),I="https://w.app/5AaZMJ",B="https://res.cloudinary.com/dabucfkmg/image/upload/v1735248623/iconColorido_bdgxgi.png";fe.useEffect(()=>{const _=setTimeout(()=>{o(!0),p([{id:1,text:`Olá! Percebemos que você estava navegando pelo site. 🐶🐾
