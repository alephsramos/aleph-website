...
`,$1=ee.button`
  ...
  font-weight: 400;
  width: 30%;
`,V1=({footerRendered:i})=>{const[n,o]=fe.useState(!1),[s,u]=fe.useState(""),[d,p]=fe.useState([]),[g,f]=fe.useState(!1),[x,v]=fe.useState("Número inválido"),[y,k]=fe.useState(!1),[b,z]=fe.useState(!1),I="https://wa.link/dojlwi",B="https://res.cloudinary.com/dabucfkmg/image/upload/v1735248623/iconColorido_bdgxgi.png";fe.useEffect(()=>{const _=setTimeout(()=>{o(!0),p([{id:1,text:`Olá! Percebemos que você estava navegando pelo site. 🐶🐾
